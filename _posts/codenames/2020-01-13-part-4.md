...
Why? Although they are initially white, they will end up colored later as the teams guess which cells are theirs. So when we click the **New Game** button, we need to erase the previous game’s colors.
